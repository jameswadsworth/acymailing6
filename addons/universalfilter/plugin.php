...
class plgAcymUniversalfilter extends acymPlugin
{
    ...
    public function onAcymDeclareConditions(&$conditions)
    {
        ...
        $conditions['classic']['universalfilter']->option .= '<div class="cell medium-3 large-2 xlarge-1 acym_vcenter margin-right-1">';
        ...
        $conditions['classic']['universalfilter']->option .= '</div>';
        $conditions['classic']['universalfilter']->option .= '<div class="cell grid-margin-x medium-auto">';
